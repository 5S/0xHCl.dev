...
export default function Home() {
  return (
    <>
      <h1 className="mb-8 font-bold text-2xl">特定商取引法に基づく表記</h1>
      ...
      <div className="space-y-8">
        ...
        <section>
          <h2 className="mb-2 font-semibold text-xl">追加手数料等の追加料金</h2>
          ...
          <ul className="mb-4 list-disc pl-6">
            <li>不具合が確認された場合、当社は迅速に修正対応を行います。</li>
            <li>
        ...
        <section>
          <h2 className="mb-2 font-semibold text-xl">受け付け可能な決済手段</h2>
        ...
        <section>
          <h2 className="mb-2 font-semibold text-xl">ソフトウェアの動作環境</h2>
          <p>契約時に個別に定めます。</p>
        </section>
      </div>
    </>
